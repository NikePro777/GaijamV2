...
export default function Home() {
  return (
    <>
      <section className="section padding-container flex flex-col xl:flex-row min-h-full ">
        {/* <div className="hero-map" /> */}

        <div className="max-container  relative z-20 flex flex-1 flex-col min-h-0">
          <h1 className="cooltext bold-52  pt-10  lg:bold-88">GaiJam</h1>
